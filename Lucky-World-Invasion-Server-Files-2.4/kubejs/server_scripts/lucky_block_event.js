...
const LUCKY_EVENTS = {
    ...
    'lucky:elewind_lucky_block': ['gift', 'cobweb'],
    'lucky:elergy_lucky_block': ['gift', 'lightning'],
    'lucky:eleice_lucky_block': ['gift', 'snow'],
    'lucky:elefire_lucky_block': ['gift', 'lava'],
    'lucky:elemental_lucky_block': ['gift', 'cobweb', 'gift', 'lightning', 'snow', 'lava'],
    'lucky:desert_lucky_block': ['gift', 'potion', 'mob'],
    'lucky:amongus_lucky_block': ['gift', 'position_tp'],
    'lucky:summer_lucky_block': ['gift', 'potion', 'mob'],
    'lucky:fire_lucky_block': ['gift', 'lava'],
    'lucky:water_lucky_block': ['gift', 'explosion', 'mob'],
    'lucky:morbius_lucky_block': ['gift', 'potion', 'mob'],
    'lucky:pink_lucky_block': ['gift', 'potion', 'mob'],
    'lucky:lucky_world_invasion_lucky_block': ['gift', 'potion', 'position_tp', 'explosion', 'lava', 'lightning', 'mob', 'snow', 'cobweb']
}
...
const $TriggerEvents = {
    ...
    gift: (server, player) => {
        ...
        if (date.getMonth() == 11 && date.getDate() > (25 - 7) && date.getDate() <= 25) {
            let randomSkins = ['red_mini_present', 'white_mini_present', 'green_mini_present', 'lavender_mini_present']
            ...
            if (date.getDate() == 24) {
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x + 1} ${player.y + 10} ${player.z + 1} {BlockState:{Name:'expandedstorage:${randomSkins[Math.floor(Math.random() * randomSkins.length)]}'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:1,tag:{display:{Lore:['"Merry Christmas !!!"'],Name:'"Christmas Eve Apple"'}}}]}}`)
            }
            ...
            if (difficulty > 100) {
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:${randomSkins[Math.floor(Math.random() * randomSkins.length)]}'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 6) + 3}${lore}}]}}`)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:${randomSkins[Math.floor(Math.random() * randomSkins.length)]}'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 5) + 2}${lore}}]}}`)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:${randomSkins[Math.floor(Math.random() * randomSkins.length)]}'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 4) + 1}${lore}}]}}`)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:${randomSkins[Math.floor(Math.random() * randomSkins.length)]}'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 3) + 1}${lore}}]}}`)
            } else {
                let items = []
                GIFT_BALL_ITEM.forEach(item => {
                    items.push(item)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:${randomSkins[Math.floor(Math.random() * randomSkins.length)]}'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:1${lore}}]}}`)
            }
            ...
            if (date.getDate() == thanksgivingDay) {
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:candy_cane_mini_present'},TileEntityData:{Items:[{Slot:0,id:cooked_chicken,Count:1,tag:{Enchantments:[{id:"fire_aspect",lvl:1}],display:{Lore:['"Happy Thanksgiving Day"'],Name:'"Turkey"'},"quark:RuneColor":"red"}}]}}`)
            }
            ...
            if (difficulty > 100) {
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:pumpkin_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 6) + 3}}]}}`)
            } else if (difficulty > 50) {
                let items = []
                GIFT_PUMPKIN_ITEM.forEach(item => {
                    items.push(item)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:pumpkin_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 5) + 2}}]}}`)
            } else if (difficulty > 20) {
                let items = []
                GIFT_PUMPKIN_ITEM.forEach(item => {
                    items.push(item)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:pumpkin_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 4) + 1}}]}}`)
            } else if (difficulty > 5) {
                let items = []
                GIFT_PUMPKIN_ITEM.forEach(item => {
                    items.push(item)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:pumpkin_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 3) + 1}}]}}`)
            } else {
                let items = []
                GIFT_PUMPKIN_ITEM.forEach(item => {
                    items.push(item)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:pumpkin_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:1}]}}`)
            }
        } else {
            if (difficulty > 100) {
                let items = []
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:netherite_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 6) + 3}}]}}`)
            } else if (difficulty > 50) {
                let items = []
                GIFT_MATERIAL_ITEM.forEach(item => {
                    items.push(item)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:diamond_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 5) + 2}}]}}`)
            } else if (difficulty > 20) {
                let items = []
                GIFT_MATERIAL_ITEM.forEach(item => {
                    items.push(item)
                ...
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:gold_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 4) + 1}}]}}`)
            } else if (difficulty > 5) {
                let items = []
                GIFT_MATERIAL_ITEM.forEach(item => {
                    items.push(item)
                })
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:iron_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:${Math.floor(Math.random() * 3) + 1}}]}}`)
            } else {
                let items = []
                GIFT_FOOD_ITEM.forEach(item => {
                    items.push(item)
                })
                server.runCommandSilent(`execute in ${player.level.dimension} run summon minecraft:falling_block ${player.x} ${player.y + 10} ${player.z} {BlockState:{Name:'expandedstorage:vanilla_wood_mini_chest'},TileEntityData:{Items:[{Slot:0,id:'${items[Math.floor(Math.random() * items.length)]}',Count:1}]}}`)
            }
        }
    },
    /**
    ...
    potion: (server, player) => {
        ...
        if (effect == 'yakurum:launch') {
            ...
            player.potionEffects.add(effect, 20 * difficulty, 0)
        }
    },
    /**
     * @param {Internal.MinecraftServer} server 
    ...
    position_tp: (server, player) => {
        let { players } = server
        let alivePlayer = players.filter(p => OPS.indexOf(p.displayName.string) == -1 && p.alive && p != player)
        if (alivePlayer.size()) {
            let targetPlayer = alivePlayer.get(Math.floor(Math.random() * alivePlayer.size()));
            server.runCommandSilent(`execute in ${targetPlayer.level.dimension} run tp ${player.displayName.string} ${targetPlayer.x} ${targetPlayer.y} ${targetPlayer.z}`)
        }
    },
    /**
     * @param {Internal.MinecraftServer} server 
    ...
    position_ex: (server, player) => {
        ...
        if (alivePlayer.size()) {
            ...
            server.runCommandSilent(`execute in ${targetPlayer.level.dimension} run tp ${player.displayName.string} ${targetPlayer.x} ${targetPlayer.y} ${targetPlayer.z}`)
            server.runCommandSilent(`execute in ${position.dimension} run tp ${targetPlayer.displayName.string} ${position.x} ${position.y} ${position.z}`)
        }
    },
    /**
     * @param {Internal.MinecraftServer} server 
    ...
    if (eventItem) {
        if (eventItem.time <= 1) {
            ...
            if (LUCKY_EVENTS[eventItem.id] && LUCKY_EVENTS[eventItem.id].length) {
                ...
                let alivePlayer = players.filter(p => OPS.indexOf(p.displayName.string) == -1 && p.alive)
                if (alivePlayer.size()) {
                     ...
                     * a: available
                     */
                    player.persistentData.put('luckyEvent', { i: eventItem.id, e: selectEvent, t: 20 * EVENT_DELAY, a: false })
                    server.tell(`[§d${player.displayName.string}§r]` + Text.translate('message.kubejs.event.server.select').getString())
                }
            }
        } else {
            eventItem.time--
...
PlayerEvents.tick(event => {
    ...
    if (player.persistentData.contains('luckyEvent')) {
        let luckyEvent = player.persistentData.get('luckyEvent')
        if (luckyEvent.a && luckyEvent.t > 0) {
            ...
            player.paint({
                ...
                event_player_text: {
                    ...
                    x: '$screenW/2 + 8', y: `$screenH/2`
                }
            })
        } else if (luckyEvent.a) {
            player.persistentData.remove('luckyEvent')
            player.paint({
            ...
            if (CAN_USE_BLOCK_CANCEL && inventory.countItem(luckyEvent.i) > 0) {
                ...
                luckyEvent.a = true
                player.setStatusMessage(Text.red(Text.translate(`message.kubejs.event.${luckyEvent.e}`, [(luckyEvent.t / 20).toFixed(0)])));
            }
        }
    }
